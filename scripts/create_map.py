...
def create_map(cell, x, y):
    ...
    if cell == '&': lands.append(Block(x* block_size, y* block_size, block_size, block_size,[1100,0], "Water"))
    ...
    if cell == '4':
        enemies.append(Enemies(x*block_size-25, y*block_size+62, 50, 36, "Seashell", 500, 0, False, True, 2000, 3))
    ...
    if cell == "<":
        decorations.append(Decoration(x* block_size +45, y* block_size+105 , 64, 25, "Chestc"))
    if cell == ">":
        decorations.append(Decoration(x* block_size+45, y* block_size +105, 64, 25, "Chesto"))
